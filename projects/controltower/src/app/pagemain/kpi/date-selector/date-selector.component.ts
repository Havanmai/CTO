...
export class DateSelectorComponent implements OnInit {
  ...
  selectOption(index: number) {
    ...
    switch (index) {
      ...
      case 3:
        this.endDate = new Date();
        this.startDate = this.getLast7Days(this.endDate);
        break;
      case 4:
        this.endDate = new Date();
  ...
  customDateSelected() {
    ...
    if (this.startDate && this.endDate) {
      ...
      this.baseService.showToast("Vui lòng chọn thời gian bắt đầu và thời gian kết thúc",Constants.TOAST_WARNING)
    }
  }
