...
@Component({
  selector: 'app-quantity-months',
  templateUrl: './quantity-months.component.html',
  styleUrls: ['./quantity-months.component.css']
})
export class QuantityMonthsComponent implements OnInit {
