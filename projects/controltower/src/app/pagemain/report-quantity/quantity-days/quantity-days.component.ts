...
@Component({
  selector: 'app-quantity-days',
  templateUrl: './quantity-days.component.html',
  styleUrls: ['./quantity-days.component.css']
})
export class QuantityDaysComponent implements OnInit {
