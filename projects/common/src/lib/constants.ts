export class Constants {
  /* public static API_URL_BASE: string = 'https://ctw.viettelpost.vn/'; */
  public static API_URL_BASE: string = 'http://10.61.145.153:8889';
  /* public static API_URL_BASE:string ='http://10.61.145.71:8888/'; */
  // public static API_URL_BASE: string = 'https://api-dev-dw.viettelpost.vn/';
 ...
 /*  public static API_URL_BASE:string = "https://box-api-dev.viettelpost.vn/services/"; */
  ...
  static CACHE_TOKEN: string = 'user:token1';
  /* static CACHE_USER_DETAIL: string = 'user:detail'; */
  static CACHE_CHECK_LOGIN: string = 'user:token';
